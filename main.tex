...
\newcommand{\screenshotplaceholder}{
    ...
    \vspace{0.3cm}
    \textbf{Screenshot Output:} \\
    \fbox{\parbox[c][2.5cm]{0.95\textwidth}{\centering\textit{[Insert screenshot-\padded{\thescreenshotcounter}{3}.png here]}\vfill}}
    \vspace{0.3cm}
}
...
\textbf{Screenshot Output:} \\
\fbox{\parbox[c][2.5cm]{0.95\textwidth}{\centering\textit{[Insert screenshot-001.png here]}\vfill}}
...
\subsection{Question 1: Caesar Cipher}
...
\subsection{Question 2: Vigenere Cipher}
...
\subsection{Question 3: Rail Fence Cipher}
...
\subsection{Question 1: RSA Encryption Scheme}
...
\subsection{Question 2: SHA-1 and MD5 Hashing}
...
\subsection{Question 3: HMAC (Hash-based Message Authentication Code)}
